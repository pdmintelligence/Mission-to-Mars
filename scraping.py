...
#function for scraping hemisphere data using code from mtmc py file***. 
def Hemi_data(browser):

    #coding imports to align with jupyter notebook codes*.
    ...
    for item in results:
        ...
        click_soup = soup(click_html, 'html.parser')
        #returning results as iterable list*.
